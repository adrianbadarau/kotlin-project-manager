package com.lenovo.coe

import com.lenovo.coe.config.ApplicationProperties
import com.lenovo.coe.config.addDefaultProfile
...
class PmAppApp(private val env: Environment) : InitializingBean {

    private val log = LoggerFactory.getLogger(PmAppApp::class.java)
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<PmAppApp>(*args) { addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(PmAppApp::class.java)
