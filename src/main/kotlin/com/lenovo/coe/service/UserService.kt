...
import com.lenovo.coe.config.ANONYMOUS_USER
import com.lenovo.coe.config.DEFAULT_LANGUAGE
import com.lenovo.coe.domain.Authority
import com.lenovo.coe.domain.User
import com.lenovo.coe.repository.AuthorityRepository
import com.lenovo.coe.repository.UserRepository
import com.lenovo.coe.security.USER
import com.lenovo.coe.security.getCurrentUserLogin
import com.lenovo.coe.service.dto.UserDTO
import com.lenovo.coe.service.util.generateActivationKey
import com.lenovo.coe.service.util.generatePassword
import com.lenovo.coe.service.util.generateResetKey
import com.lenovo.coe.web.rest.errors.EmailAlreadyUsedException
import com.lenovo.coe.web.rest.errors.InvalidPasswordException
import com.lenovo.coe.web.rest.errors.LoginAlreadyUsedException
...
class UserService(
    ...
    fun getUserWithAuthoritiesByLogin(login: String) = userRepository.findOneByLogin(login)

    fun getUserWithAuthorities(id: String) = userRepository.findById(id)

    fun getUserWithAuthorities() = getCurrentUserLogin().flatMap(userRepository::findOneByLogin)
