package com.for_the_love_of_code.kotlin_pm.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut("within(com.for_the_love_of_code.kotlin_pm.repository..*)" +
        " || within(com.for_the_love_of_code.kotlin_pm.service..*)" +
        " || within(com.for_the_love_of_code.kotlin_pm.web.rest..*)")
    ...
    fun logAround(joinPoint: ProceedingJoinPoint): Any? {
        ...
        try {
            ...
            log.error("Illegal argument: {} in {}.{}()", joinPoint.args.joinToString(),
