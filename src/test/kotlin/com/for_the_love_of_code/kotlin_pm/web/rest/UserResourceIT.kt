...
import com.for_the_love_of_code.kotlin_pm.service.mapper.UserMapper
...
class UserResourceIT {
     ...
     *
     * @see com.for_the_love_of_code.kotlin_pm.repository.search.UserSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    @BeforeEach
    fun setup() {
        val userResource = UserResource(userService, userRepository, mailService, mockUserSearchRepository)
