...
describe('Service Tests', () => {
  describe('Performance Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Performance('ID', 0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Performance', async () => {
        const returnedFromService = Object.assign(
          {
            timelinePerformance: 1,
            riskRegister: 'BBBBBB',
            mitigationPlan: 'BBBBBB'
          },
          elemDefault
        );
      ...
      it('should return a list of Performance', async () => {
        const returnedFromService = Object.assign(
          {
            timelinePerformance: 1,
            riskRegister: 'BBBBBB',
