...
describe('Service Tests', () => {
  describe('TaskType Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new TaskType('ID', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a TaskType', async () => {
      ...
      it('should update a TaskType', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB'
          },
      ...
      it('should return a list of TaskType', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB'
          },
      ...
      it('should delete a TaskType', async () => {
